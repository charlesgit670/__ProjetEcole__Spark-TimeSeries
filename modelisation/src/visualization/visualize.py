...
from modelisation.src.models.prediction import predict_arret_validation, predict_titre_validation, predict_total_validation
...
def monitoring_today_validation(df_total, df_titre, df_arret):
    ...
    incertitude_total = np.load("models/incertitudes_total.npy")
    incertitude_titre = np.load("models/incertitudes_titre.npy")
    incertitude_arret = np.load("models/incertitudes_arret.npy")

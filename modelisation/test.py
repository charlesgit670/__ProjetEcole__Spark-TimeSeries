...
df_total = df_total[(df_total.index >= "2019-01-01") & (df_total.index <= "2019-05-29")]
df_titre = df_titre[(df_titre.index >= "2019-01-01") & (df_titre.index <= "2019-05-29")]
df_arret = df_arret[(df_arret.index >= "2019-01-01") & (df_arret.index <= "2019-05-29")]
